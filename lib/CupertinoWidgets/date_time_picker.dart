...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  ...
  String formattedDate = DateFormat('MM/dd/yyyy, hh:mm a').format(DateTime.now()).toString();
                  ...
                  SizedBox(
                    ...
                    child: CupertinoDatePicker(
                        ...
                        onDateTimeChanged: (val) {
                          setState(() {
                            _chosenDateTime = val;
                            formattedDate = DateFormat('MM/dd/yyyy, hh:mm a').format(_chosenDateTime!).toString();
                          });
                        }),
                  ),
